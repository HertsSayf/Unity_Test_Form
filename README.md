...
The Chat App will be primarily designed with casual use in mind, for families and friends who need a convenient way to stay in touch. This demographic will be favoring ease of use, quick message delivery, and an interface that is intuitive and widely accessible. By targeting users who prefer casual communication over professional or high demand services, the project can focus on core messaging without requiring more complex functionalities such as team-based environments. This will let the project fall under a realistic and achievable scope of work, as the members don't have extensive experience in designing mobile apps, or java.
